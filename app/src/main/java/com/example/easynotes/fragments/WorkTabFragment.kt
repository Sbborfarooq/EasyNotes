        ...
        adapter = NoteAdapter(
            ...
            onNoteDuplicate = { note ->
                try {
                    ...
                    // Log for debugging
                    Log.d("WorkTabFragment", "Note duplicated: ${duplicateNote.title}")
                } catch (e: Exception) {
                    // Log the error and show error message
                    Log.e("WorkTabFragment", "Error duplicating note", e)
    ...
    private fun setupViewModel() {
        ...
        viewModel.getNotesByCategory("Work").observe(viewLifecycleOwner) { notes ->
            try {
                ...
                // Log for debugging
                Log.d("WorkTabFragment", "Notes updated: ${notes.size} notes")
            } catch (e: Exception) {
                Log.e("WorkTabFragment", "Error updating notes list", e)
            }
        }
    }
